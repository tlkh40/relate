...
public class JoinTableCollectionFromTargetCollection<J, T> implements Collection<J> {
    ...
    private final Set<T> targetCollection;
    private final Field sourceField;
    private final Field targetField;
    private final Collection<J> originalCollection;

    @SuppressWarnings("unchecked")
    public JoinTableCollectionFromTargetCollection(
            Object sourceInstance,
            Collection<J> originalCollection,
            Set<T> targetCollection,
        ...
        this.originalCollection =
                originalCollection != null
                        ? new ArrayList<>(originalCollection)
                        : new ArrayList<>(0);
        try {
            ...
            throw new ModelAccessException(
                    "Error initializing JoinTableCollectionFromTargetCollection on "
                            + joinClassName,
                    e);
        }
    }
