...
public interface Criteria {
    ...
    class PropertyOperand {
        ...
        private final LinkedList<RelationalDatabaseSchemaDialect.SqlFunction> functionsToApply = new LinkedList<>();
        ...
        /**
         * Create a 'is equal' condition on this property with the given value. The value may be an
         * entity in case this property is a foreign key, another property operand for properties
         * comparison, or a literal value such as a number, string, date...
         */
        ...
        public Criteria is(String entityName, String propertyName) {
            return new PropertyOperation(
                    this, PropertyOperator.EQUALS, new PropertyOperand(entityName, propertyName));
        }

        /**
         * Create a 'is not equal' condition on this property with the given value. The value may be
         * an entity in case this property is a foreign key, another property operand for properties
         * comparison, or a literal value such as a number, string, date...
         */
        ...
        public Criteria isNot(String entityName, String propertyName) {
            return new PropertyOperation(
                    ...
                    new PropertyOperand(entityName, propertyName));
        }

        /**
         * Create a '&gt;' condition on this property with the given value. The property must be
         * comparable with the given value, which may be a property operand for a comparison between
         * two properties.
         */
        ...
        public Criteria greaterOrEqualTo(String entityName, String propertyName) {
            return new PropertyOperation(
                    this,
                    PropertyOperator.GREATER_THAN_OR_EQUAL,
                    new PropertyOperand(entityName, propertyName));
        }
        ...
        public Criteria lessOrEqualTo(String entityName, String propertyName) {
            return new PropertyOperation(
                    this,
                    PropertyOperator.LESS_THAN_OR_EQUAL,
                    new PropertyOperand(entityName, propertyName));
        }
        ...
        public Criteria like(String entityName, String propertyName) {
            return new PropertyOperation(
                    this, PropertyOperator.LIKE, new PropertyOperand(entityName, propertyName));
        }
        ...
        public Criteria notLike(String entityName, String propertyName) {
            return new PropertyOperation(
                    this, PropertyOperator.NOT_LIKE, new PropertyOperand(entityName, propertyName));
        }
        ...
        public PropertyOperand toUpperCase() {
            functionsToApply.addFirst(RelationalDatabaseSchemaDialect.SqlFunction.UPPER);
            return this;
        }
        ...
        public PropertyOperand toLowerCase() {
            functionsToApply.addFirst(RelationalDatabaseSchemaDialect.SqlFunction.LOWER);
            return this;
        }

        /**
         * Extract the ISO day of week from this property that must have a compatible type for this
         * operation.
         */
        public PropertyOperand dateToIsoDayOfWeek() {
            functionsToApply.addFirst(RelationalDatabaseSchemaDialect.SqlFunction.ISO_DAY_OF_WEEK);
            return this;
        }

        /**
         * Extract the day of month from this property that must have a compatible type for this
         * operation.
         */
        public PropertyOperand dateToDayOfMonth() {
            functionsToApply.addFirst(RelationalDatabaseSchemaDialect.SqlFunction.DAY_OF_MONTH);
            return this;
        }

        /**
         * Extract the day of year from this property that must have a compatible type for this
         * operation.
         */
        public PropertyOperand dateToDayOfYear() {
            functionsToApply.addFirst(RelationalDatabaseSchemaDialect.SqlFunction.DAY_OF_YEAR);
            return this;
        }
        ...
        public PropertyOperand dateToMonth() {
            functionsToApply.addFirst(RelationalDatabaseSchemaDialect.SqlFunction.MONTH);
            return this;
        }
        ...
        public PropertyOperand dateToYear() {
            functionsToApply.addFirst(RelationalDatabaseSchemaDialect.SqlFunction.YEAR);
            return this;
        }

        /**
         * Extract the ISO week number from this property that must have a compatible type for this
         * operation.
         */
        public PropertyOperand dateToIsoWeek() {
            functionsToApply.addFirst(RelationalDatabaseSchemaDialect.SqlFunction.ISO_WEEK);
            return this;
        }
        ...
        public PropertyOperand timeToHour() {
            functionsToApply.addFirst(RelationalDatabaseSchemaDialect.SqlFunction.HOUR);
            return this;
        }

        /**
         * Extract the minute from this property that must have a compatible type for this
         * operation.
         */
        public PropertyOperand timeToMinute() {
            functionsToApply.addFirst(RelationalDatabaseSchemaDialect.SqlFunction.MINUTE);
            return this;
        }

        /**
         * Extract the second from this property that must have a compatible type for this
         * operation.
         */
        public PropertyOperand timeToSecond() {
            functionsToApply.addFirst(RelationalDatabaseSchemaDialect.SqlFunction.SECOND);
            return this;
        }
    ...
    class PropertyOperation implements Criteria {
        private final PropertyOperand left;
